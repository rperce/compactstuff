...
public class CompactTool {
    public static boolean getIsRepairable(ItemStack thisOne,
            ItemStack otherOne, String itemName) {
        Field cob, met, steel;
        try {
        ...
        try {
            return (thisOne.itemID == ((Item) cob.get(null)).itemID
                    && otherOne.itemID == CompactStuff.comBlock.blockID && otherOne
                    .getItemDamage() == Metas.DIORITE)
                    || (thisOne.itemID == ((Item) met.get(null)).itemID
                            && otherOne.itemID == CompactStuff.carbon.itemID && otherOne
                            .getItemDamage() == 4)
                    || (thisOne.itemID == ((Item) steel.get(null)).itemID
                            && otherOne.itemID == CompactStuff.itemStuff.itemID && otherOne
                            .getItemDamage() == ItemStuff.STEEL_INGOT)
