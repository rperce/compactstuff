...
public class ItemStuff extends Item {
    public static final int      GLASS_SLAG = 0, GLASS_FIBER = 1,
            DIAMOND_PLATE = 2, ALLOY_PLATE = 3, IRON_PLATE = 4,
            STEEL_PLATE = 5, STEEL_INGOT = 6, GOLD_PLATE = 7, TMOG_CRYSTAL = 8,
            BLAZE_EMERALD = 9, GOLD_ALLOYED = 10, BUTTER = 11,
            BUTTERBREAD = 12, LEMBAS = 12, MAXDMG = 13;

    public static final String[] names      = { "Glass Slag", "Glass Fiber",
            "Diamond Plate", "Carbon Alloy Plate", "Iron Plate",
            "CS Steel Plate", "CS Steel Ingot", "Gold Plate",
            "Transmogrifier Crystal", "Blaze Emerald",
            "Gilded Carbon Alloy Plate", "CS Butter", "CS Buttered Bread",
            "Lembas"                       };
    ...
    public EnumRarity getRarity(ItemStack stack) {
        return stack.getItemDamage() == TMOG_CRYSTAL ? EnumRarity.rare
                : EnumRarity.common;
    }
