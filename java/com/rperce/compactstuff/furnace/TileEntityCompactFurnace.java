...
public abstract class TileEntityCompactFurnace extends TileEntity implements
        ISidedInventory {
    /**
    ...
    public HashMap<ItemStack, ItemStack> getCustom() {
        return null;
    }
    ...
    public int getBurnTimeRemainingScaled(int par1) {
        if (getCurrentItemBurnTime() == 0) setCurrentItemBurnTime(200);
    ...
    public void updateBlock() {
        BlockCompactFurnace.updateFurnace(isBurning(), this.worldObj,
    ...
    public void readFromNBT(NBTTagCompound data) {
        ...
        setCurrentItemBurnTime(Commons.getItemBurnTime(this
                .getFurnaceItemStacks()[1]));
    }
        ...
        switch (slot) {
            case 0:
                return FurnaceRecipes.smelting().getSmeltingResult(stack) != null
                        || getCustom() != null
                        && getCustom().containsKey(stack);
            case 1:
                return Commons.getItemBurnTime(stack) > 0;
            default:
                return false;
        }
    }
    ...
    public int[] getAccessibleSlotsFromSide(int side) {
        ...
        if (side == 0) return new int[] { 1, 2 }; // bottom: result and fuel
                                                  // (bucket)
