...
public class ContainerCompactFurnace extends Container {
    ...
    public ContainerCompactFurnace(InventoryPlayer playerInv,
            TileEntityCompactFurnace te) {
        this.furnace = te;
        this.addSlotToContainer(new Slot(te, 0, 56, 17));
        this.addSlotToContainer(new Slot(te, 1, 56, 53));
        this.addSlotToContainer(new SlotFurnace(playerInv.player, te, 2, 116,
                35));
        int var3;
        ...
        for (var3 = 0; var3 < 9; ++var3) {
            this.addSlotToContainer(new Slot(playerInv, var3, 8 + var3 * 18,
                    142));
        }
    }
    ...
    public void addCraftingToCrafters(ICrafting par1ICrafting) {
        ...
        par1ICrafting.sendProgressBarUpdate(this, 0,
                this.furnace.getFurnaceCookTime());
        par1ICrafting.sendProgressBarUpdate(this, 1,
                this.furnace.getFurnaceBurnTime());
        par1ICrafting.sendProgressBarUpdate(this, 2,
                this.furnace.getCurrentItemBurnTime());
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
        ...
        if (var4 != null && var4.getHasStack()) {
            ...
            if (par2 == 2) {
                ...
                } else if (this.furnace.isCarbonFurnace()
                        && TileEntityCarbonFurnace.custom.containsKey(var5)) {
                    if (!this.mergeItemStack(var5, 0, 1, false)) return null;
